...
<a href="#layer01" data-popup="#layer01" class="layer-popup">레이어팝업 보기 111</a>
<br>
<br>
<a href="#layer02" data-popup="#layer02" class="layer-popup">레이어팝업 보기 222</a>
<br /><br />
<div style="height:1000px"></div>

<!-- 레이어 팝업 콘텐츠는 바디 엔드 태그 바로 위에 위치시키는 것이 좋습니다.-->
<div class="pop-wrap" id="layer01" style="display:none">
    <dl>
        <dt class="pop-header">로그인 <a href="#none" class="btnp-close">팝업창 닫힘</a></dt>
        <dd class="pop-box">
            <div class="pop-cont">
                <div class="pop-msg">
...
<style>
* {margin: 0;padding: 0;}
[class^="pop-wrap"] {overflow: hidden;position: fixed;top: 50%;left: 50%;width: 700px;background: #fff;z-index: 10001;border: 1px solid #896e4a;}
.pop-header {position: relative;height: 58px;padding-left: 25px;color: #000;font-size: 22px;line-height: 240%;}
.pop-header .btnp-close {position: absolute;right: 15px;top: 15px;font-size: 16px;}
.pop-cont {padding: 25px;}
.layer-scroll {overflow:hidden;}
</style>
</html>